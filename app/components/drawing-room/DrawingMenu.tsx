...
const DrawingMenu = (props: DrawingMenuProp) => {
  ...
  return (
    <div className='fixed z-10 bottom-0 border-t mx-auto w-full justify-center items-center flex xl:w-auto xl:relative xl:flex-col gap-5 xl:justify-start bg-white xl:rounded-sm p-2'>
      <div className='xl:flex flex-col max-w-[100px] gap-5  bg-white rounded-lg'>
        <div
